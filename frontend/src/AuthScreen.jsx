...
export default function AuthScreen({ onAuthenticated }) {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', password_confirmation: '', role: 'owner' })
